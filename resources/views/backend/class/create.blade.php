    ...
    <div class="card-body">
        <form method="post" action="{{route('class.store')}}">
            ...
            <div class="form-group has-success">
                ...
                <div class="">
                    <input type="text" name="classname" class="form-control" value="{{old('classname')}}" id="classname">
            ...
            <div class="form-group has-success">
                ...
                <div class="">
                    <input type="number" name="classnamenumeric"   value="{{old('classnamenumeric')}}" class="form-control" id="classnamenumeric">
            ...
            <div class="form-group has-success">
                ...
                <div class="">
                    <input type="text" name="section" class="form-control"  value="{{old('section')}}" id="section">
