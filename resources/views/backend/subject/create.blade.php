        ...
        <form method="post" action="{{route('subject.store')}}">
            ...
            <div class="form-group">
                <label for="subject_name" class="control-label">Subject Name</label>
                    <input type="text" name="subject_name" value="{{old('subject_name')}}" class="form-control" id="subject_name" placeholder="Subject Name" >
                @error('subject_name')
            ...
            <div class="form-group">
                <label for="subject_code" class="control-label">Subject Code</label>
                    <input type="number" name="subject_code" value="{{old('subject_code')}}" class="form-control" id="subject_code" placeholder="Subject Code">
                @error('subject_code')
                <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
